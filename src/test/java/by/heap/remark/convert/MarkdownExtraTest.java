 ...
 */
public class MarkdownExtraTest extends RemarkTester {

	@Override
	public Remark setupRemark() {
		return new Remark(Options.markdownExtra());
	}
	...
	@Test public void testHeader()			throws Exception { test("header", "headerids"); }
