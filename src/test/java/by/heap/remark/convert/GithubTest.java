 ...
 */
public class GithubTest extends RemarkTester {

	@Override
	public Remark setupRemark() {
		return new Remark(Options.github());
	}
	...
	@Test public void testCodeblock()		throws Exception { test("codeblock", "fenced-backtick"); }
	...
	@Test public void testTables()			throws Exception { test("tables", "codeblock"); }
